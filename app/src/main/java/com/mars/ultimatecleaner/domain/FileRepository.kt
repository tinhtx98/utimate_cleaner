...
interface FileRepository {
    suspend fun getFilesByCategory(category: FileCategoryDomain): List<FileItem>
    suspend fun searchFiles(query: String, category: FileCategoryDomain? = null): List<FileItem>
    ...
    suspend fun getStorageInfo(): StorageInfoDomain
